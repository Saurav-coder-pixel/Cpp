// Practical Code
// For bisection method when the given function is f(x)=x^3 - 4x - 9
// The tolerance was 0.001 and number of iteration that were allowed is 20
...
double bisection(double a, double b, double tol, int maxIter) {
    ...
    if (fa * fb >= 0) {
        cout << "Bisection method cannot be applied. "
             << "The function values at endpoints have the same sign." << endl;
        return 0.0;
    }
